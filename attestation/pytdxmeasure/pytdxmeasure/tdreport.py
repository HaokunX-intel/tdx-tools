...
from .utility import DeviceNode, DEVICE_NODE_NAME_DEPRECATED as DEV_DEPRECATED, DEVICE_NODE_NAME_1_0 as DEV_1_0, DEVICE_NODE_NAME_1_5 as DEV_1_5
...
class TeeTcbInfo(BinaryBlob):
    ...
    def parse(self):
        ...
        TODO:   need spec reference to update info 
...
class TdInfo(BinaryBlob):
    ...
    def parse(self):
        ...
        ref: 
            ...
            from https://www.intel.com/content/www/us/en/developer/articles/technical/intel-trust-domain-extensions.html
        '''
