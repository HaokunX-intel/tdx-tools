...
# defined in https://github.com/intel-innersource/os.linux.cloud.mvp.kernel-dev/blob/
# 5477681e024a3be49f89739a6f8e82f5c1da7d1c/arch/x86/include/uapi/asm/tdx.h#L65
# 
...
# defined in https://github.com/intel-innersource/os.linux.cloud.mvp.kernel-dev/blob/
# 5be3082770b23f8af36666a31133245f9e718965/include/uapi/linux/tdx-guest.h#L108
# 
# Layout: dir(2bit) size(14bit)         type(8bit) nr(8bit)
    ...
    * GET_TDREPORT
    ...
    def _determine_device_node(self):
        if os.path.exists(DEVICE_NODE_NAME_DEPRECATED):
            LOG.error("Deprecated device node, please upgrade to use %s or %s", 
                      DEVICE_NODE_NAME_1_0,
                      DEVICE_NODE_NAME_1_5)
            return
    ...
    def get_tdreport_bytes(self, report_data=None):
        if self.device_node_name == None or self.operators == None:
