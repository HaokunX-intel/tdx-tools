...
install_test_suite() {
    ...
    ssh -p 10026 root@localhost -o ConnectTimeout=30 "docker pull nginx:latest && docker pull redis:latest && docker pull intel/intel-optimized-tensorflow-avx512:2.8.0"
